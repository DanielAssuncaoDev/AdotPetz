                ...
                <div className="box">
                    <div className="box-esq">
                        <div className="imgs">
                            ...
                            <div> 
                                <img className="addimg" src="/assets/images/image71.svg" alt=""/> 
                            </div>
                        </div>
                        ...
                        <div className="inputs"> 
                            ...
                            </select> <input className="input2" type="text" placeholder="Peso" value={peso} onChange={e => setPeso(e.target.value)}/> <select className="select2" name="select" value={porte} onChange={e => setPorte(e.target.value)}> <option value="valor1">Selecione o Porte</option> </select>
                        </div>
                        <div className="inputs"> 
