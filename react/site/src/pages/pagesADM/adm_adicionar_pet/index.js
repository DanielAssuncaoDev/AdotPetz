...
const [imgPet2, setImgPet2] = useState(null)
const [imgPet3, setImgpet3] = useState(null)
                ...
                <div className="box">
                    <div className="box-esq">
                        <div className="imgs">
                            ...
                            {capa && <div className="input-file"> <input id="capa-input-file" type="file" onChange={e => setCapa(e.target.files[0])} /> </div> }
                        </div>
