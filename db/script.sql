...
-- insert into  INFOB_APN_TB_ADOCAO (ID_USER, ID_PET,NM_NOME_COMPLETO, DT_NASCIMENTO, DS_RG_ DS_TELEFONE, DS_CEP, DS_ENDERECO, DS_NUMERO, DS_COMPLEMENTO, DS_BAIRRO, DT_SOLICITACAO, BT_ADOCAO_CONCLUIDA, DT_ADOCAO)
-- VALUES(2, 1, )