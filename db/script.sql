...
CREATE TABLE APN_TB_ADOCAO(
	ID_ADOCAO		INT PRIMARY KEY AUTO_INCREMENT,
  	...
  	BT_ADOCAO_CONCLUIDA
  					BOOLEAN,
  	DT_ADOCAO		DATETIME,
  	FOREIGN KEY(ID_USER)REFERENCES APN_TB_USER(ID_USER),
  	FOREIGN KEY(ID_PET) REFERENCES APN_TB_PET(ID_PET) ON DELETE CASCADE ON UPDATE CASCADE
